...
<div class="main-for-list">
    <div class="list-container">
        <div class="search-container">
            <form id="search-tablet-form" method="post" action="/tabletsSV">
        ...
        <div class="list-element-container">
            ...
            <form class="list-element-form" id="list-element-form-${tablet.id?c}" method="post" action="/">
                ...
                <div class="left-container">
                    <div class="field-container">
                        ...
                        <input type="text" title="Номер минимум из 5 цифр" name="tablet-number" class="tablet-number" id="tablet-number-${tablet.id?c}" pattern="[0-9]{4,}" value="${tablet.number}" disabled/>
                    </div>
                    ...
                    <div class="field-container">
                        ...
                        <select title="Модель" name="tablet-model" class="tablet-model" id="tablet-model-${tablet.id?c}" disabled>
                    ...
                    <div class="field-container">
                        ...
                        <select title="Статус" name="tablet-status" class="tablet-status" id="tablet-status-${tablet.id?c}" disabled>
                            <#list status as st>
                    ...
                    <textarea title="Комментарий к статусу" name="tablet-status-comment" class="tablet-status-comment" id="status-comment-${tablet.id?c}" placeholder="Комментарий к статусу" disabled><#if tablet.statusComment??>${tablet.statusComment}</#if></textarea>

                    <div class="field-container">
                        <div class="label-container">
                            <label>IMEI:</label>
                        </div>
                        <input type="text" title="IMEI из 15 цифр" name="tablet-imei" class="tablet-imei" id="tablet-imei-${tablet.id?c}"  pattern="[0-9]{15,}" value="${tablet.imei}" disabled/>
                    </div>
                    ...
                    <div class="field-container">
                        ...
                        <select title="Версия OS" name="tablet-os" class="tablet-os" id="tablet-os-${tablet.id?c}" disabled>
                            <#list os as o>
                    ...
                    <div class="field-container">
                        ...
                        <input type="text" title="Телефон из 10 цифр: 9061234567" name="tablet-phone" class="tablet-phone" id="tablet-phone-${tablet.id?c}"  pattern="[0-9]{10}" value="${tablet.phone}" disabled/>
                    </div>
                    ...
                    <div class="field-container">
                        ...
                        <input type="text" title="Пин-код от Kids Place, 4 цифры" name="tablet-pin" class="tablet-pin" id="tablet-pin-${tablet.id?c}"  pattern="[0-9]{4,}" value="${tablet.pin}" disabled/>
                    </div>

                    <textarea title="Комментарий к планшету" id="tablet-comment-${tablet.id?c}" name="tablet-comment" class="tablet-comment" placeholder="Комментарий к планшету" disabled><#if tablet.tabletComment??>${tablet.tabletComment}</#if></textarea>
                </div>
